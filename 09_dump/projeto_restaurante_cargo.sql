...
CREATE TABLE `cargo` (
  ...
  `cargo_nome` varchar(100) DEFAULT NULL,
  `cargo_salario` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`idcargo`)
...
INSERT INTO `cargo` VALUES (1,'Atendente',1500.00),(2,'Garçom',1500.00),(3,'Chefe de Cozinha',3000.00),(4,'Gerente',6000.00);
