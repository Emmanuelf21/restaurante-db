...
CREATE TABLE `mesa` (
  ...
  `mesa_numero` varchar(3) DEFAULT NULL,
  `mesa_lugares` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`idmesa`)
...
INSERT INTO `mesa` VALUES (1,'1','2'),(2,'2','2'),(3,'3','4'),(4,'4','4'),(5,'5','4'),(6,'6','4'),(7,'7','4'),(8,'8','4'),(9,'9','6'),(10,'10','6'),(11,'11','8'),(12,'12','8');
