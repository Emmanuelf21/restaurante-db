...
CREATE TABLE `pagamento` (
  ...
  `fk_idpedidos` int DEFAULT NULL,
  `fk_idcliente` int DEFAULT NULL,
  PRIMARY KEY (`idpagamento`),
  KEY `fk_idpedidos` (`fk_idpedidos`),
  KEY `fk_idcliente` (`fk_idcliente`),
  CONSTRAINT `pagamento_ibfk_1` FOREIGN KEY (`fk_idpedidos`) REFERENCES `pedidos` (`idpedidos`),
  CONSTRAINT `pagamento_ibfk_2` FOREIGN KEY (`fk_idcliente`) REFERENCES `cliente` (`idcliente`)
