...
--
-- Temporary view structure for view `view_guarnicao_ingredientes`
--

DROP TABLE IF EXISTS `view_guarnicao_ingredientes`;
/*!50001 DROP VIEW IF EXISTS `view_guarnicao_ingredientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_guarnicao_ingredientes` AS SELECT 
 1 AS `idguarnicao`,
 1 AS `guarnicao_nome`,
 1 AS `ingrediente 1`,
 1 AS `ingrediente 2`,
...
--
-- Temporary view structure for view `view_principal_ingredientes`
--

DROP TABLE IF EXISTS `view_principal_ingredientes`;
/*!50001 DROP VIEW IF EXISTS `view_principal_ingredientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_principal_ingredientes` AS SELECT 
 1 AS `idprincipal`,
 1 AS `principal_nome`,
 1 AS `ingrediente 1`,
 1 AS `ingrediente 2`,
...
--
-- Temporary view structure for view `view_entrada_ingredientes`
--

DROP TABLE IF EXISTS `view_entrada_ingredientes`;
/*!50001 DROP VIEW IF EXISTS `view_entrada_ingredientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_entrada_ingredientes` AS SELECT 
 1 AS `identrada`,
 1 AS `entrada_nome`,
 1 AS `ingrediente 1`,
 1 AS `ingrediente 2`,
...
--
-- Temporary view structure for view `view_sobremesa_ingredientes`
--

DROP TABLE IF EXISTS `view_sobremesa_ingredientes`;
/*!50001 DROP VIEW IF EXISTS `view_sobremesa_ingredientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_sobremesa_ingredientes` AS SELECT 
 1 AS `idsobremesa`,
 1 AS `sobremesa_nome`,
 1 AS `ingrediente 1`,
 1 AS `ingrediente 2`,
...
--
-- Temporary view structure for view `view_bebida_ingredientes`
--

DROP TABLE IF EXISTS `view_bebida_ingredientes`;
/*!50001 DROP VIEW IF EXISTS `view_bebida_ingredientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_bebida_ingredientes` AS SELECT 
 1 AS `idbebida`,
 1 AS `bebida_nome`,
 1 AS `ingrediente`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `view_guarnicao_ingredientes`
--
...
/*!50001 VIEW `view_guarnicao_ingredientes` AS select `guarnicao`.`idguarnicao` AS `idguarnicao`,`guarnicao`.`guarnicao_nome` AS `guarnicao_nome`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente1` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 1`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente2` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 2`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente3` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 3`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente4` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 4`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente5` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 5`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente6` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 6`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`guarnicao`.`fk_idingrediente7` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 7` from `guarnicao` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_principal_ingredientes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_principal_ingredientes` AS select `prato_principal`.`idprincipal` AS `idprincipal`,`prato_principal`.`principal_nome` AS `principal_nome`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente1` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 1`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente2` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 2`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente3` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 3`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente4` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 4`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente5` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 5`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente6` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 6`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`prato_principal`.`fk_idingrediente7` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 7` from `prato_principal` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_entrada_ingredientes`
--
...
--
-- Final view structure for view `view_sobremesa_ingredientes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_sobremesa_ingredientes` AS select `sobremesa`.`idsobremesa` AS `idsobremesa`,`sobremesa`.`sobremesa_nome` AS `sobremesa_nome`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente1` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 1`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente2` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 2`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente3` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 3`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente4` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 4`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente5` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 5`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente6` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 6`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`sobremesa`.`fk_idingrediente7` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente 7` from `sobremesa` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_bebida_ingredientes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_bebida_ingredientes` AS select `bebidas`.`idbebida` AS `idbebida`,`bebidas`.`bebida_nome` AS `bebida_nome`,(select `estoque_ingredientes`.`ingrediente_nome` from `estoque_ingredientes` where (`bebidas`.`fk_idingrediente` = `estoque_ingredientes`.`idingrediente`)) AS `ingrediente` from `bebidas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
BEGIN
		insert into prato_principal values(null, principal_nome, principal_preco, fk_idingrediente1, fk_idingrediente2, fk_idingrediente3, fk_idingrediente4, fk_idingrediente5, fk_idingrediente6, fk_idingrediente7);
    END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
